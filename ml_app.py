...
def app0():
    ...
    st.image(img, caption='A healthy Liver      credit: https://www.narayanahealth.org/blog/wp-content/uploads/2015/11/shutterstock_300027005-3-1170x1033.jpg', width = 800)
